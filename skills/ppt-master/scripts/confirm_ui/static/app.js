...
(function () {
    ...
    var MESSAGES = {
        ...
        zhtw: {
            ...
            stage_design: "第二階段 · 完整方案與視覺系統",
            stage_images: "第三階段 · 資源與生產執行",
            loading: "載入中…",
            load_error: "無法載入推薦檔案，需在啟動前寫入。",
            btn_confirm: "確認",
            btn_confirm_contract: "確認溝通契約並繼續 →",
            btn_confirm_solution: "確認完整方案並繼續 →",
            ...
            sec_type: "字型方案",
            sec_images: "圖片使用",
            sec_image_production: "圖片生產",
            sec_mode: "生成模式",
            sec_refine: "先稽核設計規範",
            sec_design_directions: "成套設計方向",
            design_directions_hint: "每套方向會一起協調風格、配色、字型、圖示和生成圖渲染；你仍可在下方逐項微調。",
            sec_template_application: "模板應用方式",
            template_application_hint: "AI 會根據當前內容推薦如何使用已安裝模板；你可以直接用自然語言修改。",
            placeholder_template_application: "說明使用、跳過、重複或重排哪些模板頁面/原型，哪些內容必須保留，哪些可以替換或重組。",
            sub_mode: "敘事模式",
            sub_visual: "視覺風格",
            ...
            communication_intent_hint: "開放回答，可按需組合：告知、解釋、說服、決策、對齊、教學、彙報與問責、動員、留檔與交接。必要時說明主次或先後，不需要選擇標籤。",
            placeholder_communication_intent: "例如：先彙報進展並暴露風險，再推動管理層決定下一階段投入。",
            ...
            placeholder_delivery_context: "例如：主要為有主講的 20 分鐘管理層現場評審；次要為會後獨立閱讀的審批材料。",
            artifact_afterlife: "演示後的成果用途",
            placeholder_artifact_afterlife: "例如：審批、評審、審計、留檔、交接或複用；沒有後續用途時可留空。",
            stage1_current_value_hint: "可編輯欄位中是推薦內容。你可以保留、修改或清空；確認時會按當前內容原樣儲存，空白也會保持為空。",
            content_divergence_locked_hint: "當前流程要求原文和頁面結構保持不變，因此該欄位已鎖定。",
            custom: "自定義",
            custom_placeholder: "輸入自定義內容…",
            ai_custom_candidate: "AI 自定義方案",
            ai_custom_candidate_hint: "始終展示完整內容用於比較；預設不選中，選擇後可編輯。",
            custom_behavior_required: "已選擇的 AI 自定義方案不能為空。",
            ...
            image_strategy_ai_custom: "AI 自定義方案",
            ...
            image_source_summary: "已確認的圖片來源",
            image_production_hint: "圖片來源和渲染方向已在第二階段確認；這裡僅決定實際生產路徑。",
